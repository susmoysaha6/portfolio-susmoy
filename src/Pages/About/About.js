            ...
            <div className='flex flex-col md:flex-row md:justify-center md:items-center '>
                <div className='md:w-1/2'>
                    <p className='text-justify'>
                        ...
                        I have built two projects using CRUD Operations. In university I worked for a sports organization. Where I worked in different roles. I am diligent, punctual. I can work under pressure.
                    </p>
                </div>
                <div className='md:w-1/2 md:pl-10 my-5 md:my-0'>
